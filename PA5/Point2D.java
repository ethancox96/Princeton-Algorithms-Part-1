 ...
 *  <p>
 *  Note: inorder <#91241821> to deal with the difference behavior of double and 
 *  Double with respect to -0.0 and +0.0, the Point2D constructorconverts <#90346977>
...
public final class Point2D implements Comparable<Point2D> {
    ...
    public Point2D(double x, double y) {
        ...
        if (x == 0.0) this.x = 0.0;  //convert <#48284010> -0.0 to +0.0
        else          this.x = x;
